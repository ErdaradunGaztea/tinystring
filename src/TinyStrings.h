...
inline TinyStrings::TinyStrings(const std::vector<std::vector<int> > &data, AlphabetSimple alphabet) : data_(data),
    alphabet_(std::move(alphabet)) {
}

inline TinyStrings::TinyStrings(const std::vector<int> &scalar_data, AlphabetSimple alphabet) : alphabet_(
    std::move(alphabet)) {
